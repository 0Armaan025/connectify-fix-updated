...
class UserPostStorageRepository {
  Client client =
  ...
  Future<String> saveUserPostMedia(
    ...
    try {
      ...
      if (sizeInMB > 120) {
        showSnackBar(
          context,
          "The ${isImage ? 'image' : 'video'} exceeds the maximum allowed size of 120 MB. Please upload a smaller file.",
        );
      ...
      final result = await storage.createFile(
        bucketId: APPWRITE_POSTS_BUCKET_ID,
        fileId: ID.unique(),
